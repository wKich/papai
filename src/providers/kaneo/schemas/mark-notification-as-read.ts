...
// Path parameters
export const MarkNotificationAsReadPathParamsSchema = z.object({
  id: z.string(),
})
...
export type MarkNotificationAsReadPathParams = z.infer<typeof MarkNotificationAsReadPathParamsSchema>
