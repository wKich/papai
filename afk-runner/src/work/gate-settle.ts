...
// The sidecar-derivation half (expected content + sidecar re-reads) lives in
// gate-expected.ts; re-exported here so the settle seam's importers are
// unchanged.
export { escalationExpectedContent, expectedContentFor, readReviewResultFromSidecars } from './gate-expected.js'
